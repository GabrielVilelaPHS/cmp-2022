...
{
       0,    30,    30,    30,    45,    57,    65,    73,    80,    90,
      96,   102,   111,   117,   123,   131,   137,   145,   151,   155,
     159
};
#endif
...
static const char *const yytname[] =
{
  ...
  "'('", "')'", "$accept", "program", "$@1", "stmts", "stmt", "atribuicao",
...
{
       2,    -4,     0,    11,     2,   -10,   -10,   -10,   -10,   -10,
      -4,     4,     5,     7,   -10,    -4,   -10,   -10,   -10,    -6,
      -4,    -4,    -4,    -4,    -4,     4,   -10,     5,     5,     7,
       7,   -10
};
...
{
       0,     0,     0,     0,     2,     5,     6,    18,    19,    20,
       0,     7,    11,    14,    16,     0,     1,     3,     4,     0,
       0,     0,     0,     0,     0,     8,    17,     9,    10,    12,
      13,    15
};
...
{
     -10,   -10,   -10,   -10,    19,   -10,    -3,    -2,    -1,    -9
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     3,    17,     4,     5,     6,    11,    12,    13,    14
};
...
{
       7,     8,     9,    20,    21,     1,     2,    19,    15,    26,
      10,    16,    25,    20,    21,    31,    22,    23,    27,    28,
      24,    29,    30,    18
};

static const yytype_int8 yycheck[] =
{
       4,     5,     6,     9,    10,     3,     4,    10,     8,    15,
      14,     0,    15,     9,    10,    24,    11,    12,    20,    21,
      13,    22,    23,     4
};
...
{
       0,     3,     4,    17,    19,    20,    21,     4,     5,     6,
      14,    22,    23,    24,    25,     8,     0,    18,    20,    22,
       9,    10,    11,    12,    13,    22,    15,    23,    23,    24,
      24,    25
};
...
#line 80 "calc.y"
		...
		aux->name = (yyvsp[-2].args).ident;				//$$->children[0]->name = NULL;
		(yyval.no)->children[0] = aux;				//apaga
...
#line 151 "calc.y"
                    {
		(yyval.no) = create_noh(IDENT, 0); //(nome do nó, a quantidade de filho)
...
#line 155 "calc.y"
                      {
		(yyval.no) = create_noh(INTEGER, 0); //(nome do nó, a quantidade de filho)
...
#line 159 "calc.y"
                     {
		(yyval.no) = create_noh(FLOAT, 0); //(nome do nó, a quantidade de filho)
